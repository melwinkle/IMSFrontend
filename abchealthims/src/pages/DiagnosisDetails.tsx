...
export default function DiagnosisDetails() {
  ...
  const handleDelete = async () => {
    if (window.confirm('Are you sure you want to archive this diagnosis?')) {
      try {
        dispatch(archiveDiagnosis({diagnosisId:id as string, diagnosisData:{status:'Archive'}}));
      } catch (error) {
        ...
        {isDoctor && (
          <div className="space-x-3">
            ...
            <button
              ...
              className="bg-red-50 border border-red-200 text-red-600 px-4 py-2 rounded-md hover:bg-red-100 transition-colors duration-200 inline-flex items-center"
            >
